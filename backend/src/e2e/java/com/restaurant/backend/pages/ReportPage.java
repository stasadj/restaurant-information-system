...
public class ReportPage extends ManagerPage {
    ...
    @FindBy(id = "granularity_input")
    WebElement granularityInput;
    ...
    public void selectYearlyGranularity() {
        Utilities.visibilityWait(driver, granularityInput, 10).click();
        Utilities.visibilityWait(driver, yearlyOption, 10).click();
    }
