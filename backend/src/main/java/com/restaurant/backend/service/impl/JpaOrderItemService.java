...
public class JpaOrderItemService implements OrderItemService {
    ...
    @Override
    public List<OrderItem> acceptOrderItems(Staff staff, List<Long> ids) {
        ...
        String message = messageBuilder.toString(); // TODO return message, too
        return acceptedItems;
    }

    @Override
    public List<OrderItem> declineOrderItems(Staff staff, List<Long> ids) {
        boolean isCook = staff instanceof Cook;
    ...
    @Override
    public List<OrderItem> prepareOrderItems(Staff staff, List<Long> ids) {
        boolean isCook = staff instanceof Cook;
